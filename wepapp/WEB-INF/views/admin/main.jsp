...
<body>
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-form">
					<form method="post" action="${pageContext.servletContext.contextPath }/admin/main" enctype="multipart/form-data">
						...
						<input id="welcomeMessage" name="welcomeMsg" type="text" value="${siteVo.welcomeMsg }">

						<label class="block-label">프로필 이미지</label>
						<img id="profile" src="${pageContext.request.contextPath }${siteVo.profileImg }">
